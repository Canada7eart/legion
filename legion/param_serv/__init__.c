...
#endif
#include <math.h>
#define __PYX_HAVE__legion__param_serv____init__
#define __PYX_HAVE_API__legion__param_serv____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'legion.param_serv.__init__' */
#define __Pyx_MODULE_NAME "legion.param_serv.__init__"
int __pyx_module_is_main_legion__param_serv____init__ = 0;

/* Implementation of 'legion.param_serv.__init__' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static char __pyx_k_param_serv[] = "param_serv";
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_u_param_serv;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_param_serv, __pyx_k_param_serv, sizeof(__pyx_k_param_serv), 0, 1, 0, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initparam_serv(void); /*proto*/
PyMODINIT_FUNC initparam_serv(void)
#else
PyMODINIT_FUNC PyInit_param_serv(void); /*proto*/
PyMODINIT_FUNC PyInit_param_serv(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_param_serv(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("param_serv", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_legion__param_serv____init__) {
  ...
  if (unlikely(__Pyx_SetPackagePathFromImportLib("legion", __pyx_n_u_param_serv) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 3; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "legion.param_serv")) {
      if (unlikely(PyDict_SetItemString(modules, "legion.param_serv", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 3; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "legion/param_serv/__init__.py":3
 * 
 *              # <<<<<<<<<<<<<<
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init legion.param_serv.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init legion.param_serv.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
